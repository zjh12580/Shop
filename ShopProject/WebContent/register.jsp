	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" id="register_id" action="${pageContext.request.contextPath}/registerServ" method="post" style="margin-top: 5px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="password" class="form-control" id="confirmpwd"  name="reconfirmpwd"
								placeholder="请输入确认密码">
						</div>
					</div>
					<div class="form-group">
