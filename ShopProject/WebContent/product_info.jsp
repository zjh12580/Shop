			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${productInfo.market_price}</strong> 参 考 价：
						<del>￥：${productInfo.market_price}</del>
					</div>

					<div style="margin: 10px 0 10px 0;">
						促销: <a target="_blank" title="限时抢购 (2014-07-30 ~ ${productInfo.pdate})"
							style="background-color: #f07373;">${productInfo.pdesc}</a>
					</div>
